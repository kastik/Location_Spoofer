...
import com.kastik.locationspoofer.data.datastore.SavedRouteSerializer
...
object SavedRoutesModule {
    ...
    @Provides
    @Singleton
    fun provideSavedRoutesDataStore(@ApplicationContext context: Context): DataStore<SavedRoutes> {
    ...
    @Provides
    @Singleton
    fun provideSavedRoutesRepo(dataStore: DataStore<SavedRoutes>): SavedRouteRepo {
        return SavedRouteRepo(dataStore)
    }
