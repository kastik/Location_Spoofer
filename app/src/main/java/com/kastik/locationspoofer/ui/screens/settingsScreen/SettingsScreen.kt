...
fun SettingsScreenContent(
    ...
    Scaffold {
        Column(
            ...
            SettingsSwitchItem(
                title = "Auto-Zoom Marker",
                checked = preferences.autoZoomMarker,
                onCheckedChange = onToggleMarkerZoom
            )
...
fun SettingsScreenPreview() {
    LocationSpooferTheme {
        SettingsScreenContent(
            preferences = UserPreferences.newBuilder().setEnableXposed(false)
                .setAutoZoomMarker(true).setDarkMode(DarkMode.followSystem).build(),
            onToggleMarkerZoom = {},
            onToggleDarkMode = {},
            onToggleStatusBar = {},
        )
