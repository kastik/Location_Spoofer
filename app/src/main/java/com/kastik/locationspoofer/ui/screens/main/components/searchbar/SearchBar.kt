package com.kastik.locationspoofer.ui.screens.main.components.searchbar
...
import com.kastik.locationspoofer.ui.screens.main.components.searchbar.sub.ShowQueryResults
...
fun TopSearchBar(
    ...
    changeMarker: (markerData: MarkerData) ->Unit,
            ...
            LazyRow(
                ...
                items(savedPlaces.placeList) { place ->
                    FilterChip(
                        ...
                        label = {
                            Text(
                                text = place.placePrimaryText.substringBefore('\n'),
                                maxLines = 1,
                                overflow = TextOverflow.Ellipsis)},
                        onClick = {
                            changeMarker(place.toMarkerData())
                        }
                    )
                }
            }
